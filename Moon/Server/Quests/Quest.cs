  ...
  public class Quest
  {
    ...
    public static void LoadDbItems()
    {
      ...
      MoonApplication.Server.QuestList["test-quest-1"] = new Quest
      {
        ...
        Description = "Для начала, убейте 10 скелетов мечников и принесите мне 3 их меча, да и не приходите ко мне пока вы не наберете 7 уровень",
        CompleteDescription = "Ндя... качество оставляет желать лучшего, но ничего, на переплавку годятся.",
      ...
      MoonApplication.Server.QuestList["test-quest-2"] = new Quest
      {
        ...
        Description = "Вы славно потрудились в прошлый раз, и раз вы уже знаете дорогу, не принесете ли вы мне 10 черепов тех самых скелетов, конечно не безвозмедно",
